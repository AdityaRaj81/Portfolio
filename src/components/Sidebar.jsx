        ...
        <div className="flex flex-col h-full p-6">
          ...
          <nav className="flex flex-col gap-1 flex-1">
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 p-3 px-4 text-text-secondary rounded-xl transition-all duration-300 ease-in-out relative overflow-hidden group ${isActive
                  ? 'bg-gradient-to-r from-primary-500/15 to-accent-purple/10 text-primary-500 font-medium shadow-md border border-primary-500/20'
            ...
            >
              {({ isActive }) => (
                <>
                  <div className={`p-1.5 rounded-lg transition-all duration-300 ${isActive ? 'bg-primary-500/20 text-primary-500' : 'group-hover:bg-primary-500/10 group-hover:text-primary-500'
                    }`}>
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-bg-secondary/95 backdrop-blur-[24px] border-t border-border-primary z-[1000] px-2 py-3 shadow-2xl">
        <div className="flex justify-around items-center max-w-md mx-auto">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `flex flex-col items-center gap-1 p-2.5 rounded-xl transition-all duration-300 min-w-[60px] ${isActive
